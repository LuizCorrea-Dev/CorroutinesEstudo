...
import luiz.correa.corroutineaplication.databinding.MainFragmentBinding
...
class MainFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        /* viewModelProvider passando o ciclo de vida "owner" que é o fragmento,
        como segundo parâmetro passando um factory que permite que crie um viewModel,
        e passando para este ViewModel o repositório como injeção de dependencia,
        porque o ViewModel recebe no seu contrutor o repositório*/
